...
> **[2026-08-03] Phase 1 완료 — 결과는 `methodology_review_20260720.md` §23.**
> 솔버는 구현·검증 완료(test 케이스 2개 × 45 자세 전 구간 토크가 Motor-CAD 대비
> 평균 -0.18%/-0.06%). **AI 초기화는 §4의 사전 기준에 따라 음성**: curl-A u₀는
> zero 대비 반복 -15.3%이나 직전각도 warm-start(9.27회)에 크게 못 미친다(14.82회).
> 아래 §1의 전제 하나가 실측과 다르다는 점도 §23a에 기록했다 — export는 45° 웨지가
> 아니라 고정자 [-45,0]·회전자 [-65.5,-20.5]의 합집합이다.
