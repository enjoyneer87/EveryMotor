...
def build_samples_from_doe_manifest(
    ...
    # Prefer train_manifest.json (training catalog, generated by
    # build_train_manifest()) over doe_manifest.json (DOE parameters only).
    train_manifest_path = root / "train_manifest.json"
    doe_manifest_path = root / "doe_manifest.json"
    if train_manifest_path.exists():
        ...
        raise FileNotFoundError(
            f"Neither train_manifest.json nor doe_manifest.json found in {root}"
        )
